import {Timestamp, Uuid} from "@/types/basics";
...
export interface ProjectWithInfo extends ProjectInfo {
    project: Project
}

export type ProjectWithInfoPost = Omit<ProjectWithInfo, 'createdAt' | 'updatedAt'>
